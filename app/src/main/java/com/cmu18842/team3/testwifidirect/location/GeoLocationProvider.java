package com.cmu18842.team3.testwifidirect.location;
...
import com.cmu18842.team3.testwifidirect.DeviceDetailFragment;
...
public class GeoLocationProvider extends Service implements LocationListener {
    ...
    private void sendLocationToUI(Location location) {
        Intent i=new Intent(context, DeviceDetailFragment.class);
        i.putExtra("type", DeviceDetailFragment.INTENT_TYPE_LOCATION_CHANGE);
